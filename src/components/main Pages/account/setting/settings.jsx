...
const Settings = () => {
  ...
  return (
    <>
      <div
        className="container-fluid container-md d-flex justify-content-center px-0 px-md-3 pt-3 pt-md-4 "
        style={{ marginTop: "4rem" }}
      >
        <div
          className="row w-100 border bg-white rounded"
          style={{ maxWidth: "930px" }}
        >
          <div className="col-3 d-none d-sm-flex flex-column border-end p-0">
            <NavLink
              to="/account/edit"
              className="text-dark text-decoration-none"
            >
              <button className="border-0 bg-white w-100 text-start px-4 settings active rounded">
                Edit Profile
              </button>
            </NavLink>
            <NavLink
              to="/account/professional_account-settings"
              className="text-dark text-decoration-none"
            >
            ...
            <SwitchToAccount />
            <div className="border-top p-4 mt-auto">
              <div className="cursor d-flex flex-column">
                <svg height="12" viewBox="0 0 500 100" width="60">
                  <defs>
                    <linearGradient
                ...
                <span className="fw-500 text-primary my-2">
                  Accounts Center
                </span>

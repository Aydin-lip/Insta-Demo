...
const UserProfile = (props) => {
  useEffect(() => {
    ...
    if (document.location.pathname === `/${props.data.login.username}`) {
      btns[0].classList.add("active-btn-profile");
    } else if (
      document.location.pathname === `/${props.data.login.username}/tagged`
    ) {
    ...
    <>
      <div>
        <div className="container">
          <ProfileSmUp data={props.data} />
          <ProfileSmDown data={props.data} />
          ...
          <div className="bottom-profile">
            <div className="border-top w-100 d-none d-sm-flex w-100 justify-content-center">
              ...
              >
                <NavLink
                  to={`/${props.data.login.username}/tagged`}
                  className="text-decoration-none text-black d-flex"
                >
                  <div
                    className="position-absolute top-0 bottom-0 end-0 start-0"

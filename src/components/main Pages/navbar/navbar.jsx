const Navbar = () => {
          ...
          <div className="row" style={{ width: "110%" }}>
            ...
            <div className="col-4 d-none d-md-block">
              <div className="position-relative">
                ...
                <i
                  onClick={onCloseFunc}
                  className="fa fa-times-circle icon-close-nav d-none"
                ></i>
              </div>
            </div>
            <div
  ...
  function focusInputSearch(event) {
    ...
    const iconSearch = document.querySelector(".icon-search-nav");
    iconClose.classList.remove("d-none");
    iconSearch.classList.add("d-none");
    event.target.onFocus = false;
  }
  function focusOutInputSearch() {
    onCloseFunc();
  }

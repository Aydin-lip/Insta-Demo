      ...
      <div className="w-100 h-100 d-flex justify-content-center align-items-center">
        <div className="text-center">
          ...
          <p className="text-muted" style={{ fontSize: ".9rem" }}>
            Notifications are off for messages you move here, but you can turn
            them on anytime.
          </p>
          <button
...
export default connect(null, mapDispatchToProps)(MessagesGeneral);
